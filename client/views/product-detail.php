    ...
    <div class="content-product-info_left">
      <div class="container-product-image_box">
        ...
        <div class="content-product_info-row">
          ...
          <div class="column">
            <img
              src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTu4kVhpjc0rP9G11pdbuOTs9ptwZNgoO_tlQ&usqp=CAU"
              alt="Snow" style="width:100%" onclick="myFunction(this);">
          </div>
          <div class="column">
            <img
              src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcS3PN_vFvRTsMK53gDly0EIIAt_Mzkq3DsnIA&usqp=CAU"
              alt="Mountains" style="width:100%" onclick="myFunction(this);">
          </div>
          <div class="column">
            <img
              src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTVdps4X4WZmcF7f1QTd_8LdoH8m3XXB46sbA&usqp=CAU"
            ...
            <div class="cmtt__info">
              ...
              <div class="cmtt__content-box">
                ...
                <a onclick="return confirm('Bạn có muốn xoá danh mục này ?')"
                  href="index.php?url=binh-luan-delete&id=<?= $key['cmtt_id']?>" class="cmtt__delete" href=""><i
