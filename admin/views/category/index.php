    ...
    <div class="col-4 mt-3">
      ...
      <form method="POST" action="index.php?url=category-edit-save">
        ...
        <div class="mb-3 border-right ">
          ...
          <input value="<?= $cate[0]["dm_name"]?>" type="text" class="form-control" name="dm_name"
            placeholder="Tên danh mục ..." id="exampleInputEmail1" aria-describedby="emailHelp">
      ...
      <table class="table">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td><a href="index.php?url=category-delete&id=<?=$item['dm_id']?>"
                onclick="return confirm('Bạn có muốn xoá danh mục này ?')" class="btn btn-danger">Xoá</a></td>
          </tr>
          <?php } ?>
        </tbody>
      </table>
