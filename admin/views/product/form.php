  ...
  <form action="index.php?url=product-form-add-save" method="POST" class="row" enctype='multipart/form-data'>
    <div class="col-6">
      <div class="mb-3">
        ...
        <input type="text" class="form-control" name="sp_name" placeholder="Tên sản phẩm" id="exampleInputEmail1"
          aria-describedby="emailHelp">
        <p class="text-danger"><?= !empty($errorName) ? $errorName : ''  ?></p>
      </div>
      <div class="mb-3">
        <label for="exampleInputPassword1" class="form-label">Ảnh</label>
        <input type="file" accept="image/*" id="imgInp" class="form-control" name="sp_image" id="exampleInputPassword1">
      ...
      <div class="mb-3">
        ...
        <input type="text" class="form-control" name="sp_price" placeholder="Giá sản phẩm" id="exampleInputPassword1">
    ...
    <div class="col-6">
      ...
      <div class="mb-3">
        ...
        <input type="text" class="form-control" name="sp_sale" placeholder="Giá sale" id="exampleInputPassword1">
        <p class="text-danger"><?= !empty($errorPriceSale) ? $errorPriceSale : ''  ?></p>
      </div>
      <div class="mb-3">
        <label for="exampleInputPassword1" class="form-label">Số lượng</label>
        <input type="number" class="form-control" name="sp_quantity" placeholder="Số lượng" id="exampleInputPassword1">
      ...
      <div class="mb-3">
        ...
        <div class="form-floating">
          <textarea class="form-control" name="sp_description" id="floatingTextarea2" style="height: 120px"></textarea>
