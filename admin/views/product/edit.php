  ...
  <form action="index.php?url=product-edit-save" method="POST" class="row" enctype='multipart/form-data'>
    <div class="col-6">
      ...
      <div class="mb-3">
        ...
        <input type="text" class="form-control" value="<?=$product[0]["sp_name"]?>" name="sp_name"
          placeholder="Tên sản phẩm" id="exampleInputEmail1" aria-describedby="emailHelp">
        <p class="text-danger"><?= !empty($errorName) ? $errorName : ''  ?></p>

      </div>
      <div class="mb-3">
        <label for="exampleInputPassword1" class="form-label">Ảnh</label>
        <input type="file" accept="image/*" id="imgInp" class="form-control" value="<?=$product[0]["sp_image"]?>"
          name="sp_image" id="exampleInputPassword1">
        <input type="text" class="form-control" hidden value="<?=$product[0]["sp_image"]?>" name="sp_image"
      ...
      <div class="mb-3">
        ...
        <input type="text" class="form-control" value="<?=$product[0]["sp_price"]?>" name="sp_price"
          placeholder="Giá sản phẩm" id="exampleInputPassword1">
        <p class="text-danger"><?= !empty($errorPrice) ? $errorPrice : ''  ?></p>
      </div>
      <div class="mb-3">
        <label for="exampleInputPassword1" class="form-label">Giá giảm</label>
        <input type="text" class="form-control" value="<?=$product[0]["sp_sale"]?>" name="sp_sale"
          placeholder="Giá sale" id="exampleInputPassword1">
        <p class="text-danger"><?= !empty($errorPriceSale) ? $errorPriceSale : ''  ?></p>
      </div>
      <div class="mb-3">
        <label for="exampleInputPassword1" class="form-label">Số lượng</label>
        <input type="number" class="form-control" name="sp_quantity" value="<?=$product[0]["sp_quantity"]?>"
          placeholder="Số lượng" id="exampleInputPassword1">
    ...
    <div class="col-6">
      <div class="mb-3">
        ...
        <select class="form-control" value="<?= $product[0]["dm_id"]?>" name="dm_id"
      ...
      <div class="mb-3">
        ...
        <select class="form-control" value="<?= $product[0]["kt_id"]?>" name="kt_id"
          aria-label="Default select example">
